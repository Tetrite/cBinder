...
class DynamicLibrariesTest(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        os.chdir("../..")
        os.system(r'python main.py sources -f ' + str(self.sources_path) + ' -d ' + str(self.destination_path) + ' shared')
        os.chdir(os.path.join(self.destination_path, 'sources'))
        os.environ['PATH'] = os.getcwd() + os.pathsep + os.environ['PATH']

    def test_generate_bindings_to_simple_add_function_integer(self):
        from tests.dynamiclibraries.generated.sources import add
        sum = add.add(1, 2)
    ...
    def test_generate_bindings_to_simple_print_char_function(self):
        from tests.dynamiclibraries.generated.sources import char
