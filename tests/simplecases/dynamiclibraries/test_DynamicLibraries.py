...
class DynamicLibraries(unittest.TestCase):
    ...
    def test_generate_bindings_to_simple_add_function_integer(self):
        from tests.simplecases.dynamiclibraries.generated.sources import add
        sum = add.add(1, 2)
    ...
    def test_generate_bindings_to_simple_print_char_function(self):
        from tests.simplecases.dynamiclibraries.generated.sources import char
